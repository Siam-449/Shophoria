    ...
    <div className="bg-slate-50 dark:bg-slate-950">
      <main className="container mx-auto p-4 sm:p-6 lg:p-8 min-h-[60vh]">
         <div className="text-center my-12">
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4">Fashion</h1>
            <p className="text-lg text-slate-600 dark:text-slate-400">Discover our collection of stylish bags and accessories.</p>
        </div>
